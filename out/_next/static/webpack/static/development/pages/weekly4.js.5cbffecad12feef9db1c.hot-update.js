...
function Weekly4(props) {
  ...
  var handleClick = function handleClick(e) {
    ...
    if (value === '=') {
      ...
      try {
        setNumber(eval("".concat(number, " * 1 /100")));
      } catch (e) {
        setNumber('ERROR');
      }
    } else {
...
var CalculatorBg = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly4__CalculatorBg",
  componentId: "sc-1elaocm-0"
})(["position:absolute;top:0;left:0;right:0;bottom:0;z-index:-1;filter:blur(17px);background-image:url('https://images.unsplash.com/photo-1564939558297-fc396f18e5c7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1800&q=80');"]);
...
})(["margin:2px;width:", ";height:66px;", " &:active{box-shadow:inset rgba(0,0,0,0.5) 0px 2px 8px;outline:none;>div{box-shadow:inset rgba(0,0,0,0.2) 0px 2px 8px;}}&:focus{outline:none;}>div{width:", ";height:60px;margin:3px;line-height:64px;border-radius:12px;font-weight:bold;font-size:30px;}"], function (props) {
...
})(["position:absolute;top:0;left:0;right:0;width:100%;height:80px;background:#050505;>p{margin:0 auto;width:288px;text-align:right;padding:0;color:#B85709;line-height:80px;font-size:", "}"], function (props) {
  return props.length > 12 ? '22px' : '40px;';
});
var CalculatorCase = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly4__CalculatorCase",
  componentId: "sc-1elaocm-6"
})(["border-radius:12px;padding:10px;background:linear-gradient(90deg,#010005 0%,#151C22 100%);"]);
var Calculator = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly4__Calculator",
  componentId: "sc-1elaocm-7"
})(["width:300px;height:470px;background:linear-gradient(304.68deg,#BDBEAC 0%,#BEBFAD 100%);border-radius:12px;overflow:hidden;padding:20px;"]);
var ContentBox = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly4__ContentBox",
  componentId: "sc-1elaocm-8"
})(["position:absolute;display:flex;width:84vw;height:100%;z-index:3;top:0;left:8vw;right:8vw;bottom:0;box-shadow:0 10px 20px rgba(0,0,0,.3);align-items:center;justify-content:center;overflow:hidden;"]);

/***/ })

})
//# sourceMappingURL=weekly4.js.5cbffecad12feef9db1c.hot-update.js.map
...
})(["position:absolute;top:0;left:0;right:0;height:100%;background:#1a1a1a;z-index:3;animation:", " 0.5s cubic-bezier(0,0,0.2,1) forwards;animation-delay:", ";", " transition:all 0.4s cubic-bezier(0,0,0.2,1);transition-delay:4s;"], SlideOut, function (props) {
  return props.delay;
}, function (props) {
...
})(["margin:0 2rem;height:calc(100% - 120px);display:flex;overflow:hidden;position:relative;z-index:0;align-items:flex-end;>ul{height:500px;background:#000;position:relative;flex:0 0 55%;margin-right:4%;&:first-child{margin-left:12%;", " transition:height 0.5s cubic-bezier(0,0,0.2,1);}&:last-child{>li>div>div{opacity:0.4 !important;}}}"], function (props) {
  return props.open && 'height:600px; transition-delay:0.4s;';
});
...
//# sourceMappingURL=weekly3.js.f01d5c73132ce9edfd0e.hot-update.js.map
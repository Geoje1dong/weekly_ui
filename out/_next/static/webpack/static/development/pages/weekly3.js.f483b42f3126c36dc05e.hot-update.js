...
})(["background:none;color:#fff;border:1px solid #fff;box-shadow:0 2px 0 rgba(0,0,0,0.045);text-shadow:0 -1px 0 rgba(0,0,0,0.12);transition:all .3s;cursor:pointer;font-weight:inherit;padding:4px 8px;font-size:0.6rem;border-radius:4px;>svg{margin-right:8px;}&:hover{outline:none;background:rgba(255,255,255,0.9);color:#000;}"]);
...
//# sourceMappingURL=weekly3.js.f483b42f3126c36dc05e.hot-update.js.map
...
var SlideOut = keyframes(["to{top:-100%;}"]);
var ScaleKeyprame = keyframes(["0%{transform:scale(1);}40%{transform:scale(1.2);}100%{transform:scale(1);}"]);
...
var SlideStyle = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].li.withConfig({
  ...
  if (props.current === props.index) {
    return css(["animation:", " 0.6s cubic-bezier(0,0,0.2,1);"], ScaleKeyprame);
  }
});
...
//# sourceMappingURL=weekly3.js.eb3f29c02481256a8bc3.hot-update.js.map
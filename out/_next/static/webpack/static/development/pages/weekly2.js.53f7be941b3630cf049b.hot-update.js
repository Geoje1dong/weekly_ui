...
function Weekly2(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_components_contentLayout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    __self: this
  }, "ex) 55., 44., 64., 35., 37., 94."), __jsx(_components_ui_input__WEBPACK_IMPORTED_MODULE_6__["default"], {
    theme: "dark",
    type: "tel",
    name: "cardNumber",
    value: cardNumber,
...
})(["position:relative;width:100%;>button{position:absolute;right:10px;top:-20px;z-index:2;}>em{font-size:0.7em;position:absolute;right:10px;top:4px;opacity:0.8;}"]);
...
//# sourceMappingURL=weekly2.js.53f7be941b3630cf049b.hot-update.js.map
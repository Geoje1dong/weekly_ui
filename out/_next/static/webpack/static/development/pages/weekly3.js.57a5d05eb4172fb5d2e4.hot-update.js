...
})(["position:absolute;top:0;left:0;right:0;height:100%;background:#1a1a1a;z-index:3;animation:", " 0.5s cubic-bezier(0,0,0.2,1) forwards;animation-delay:", ";", " transition:0.5s cubic-bezier(0,0,0.2,1);"], SlideOut, function (props) {
  return props.delay;
}, function (props) {
  return props.open && 'transform:translateY(100%); background:red;';
});
...
//# sourceMappingURL=weekly3.js.57a5d05eb4172fb5d2e4.hot-update.js.map
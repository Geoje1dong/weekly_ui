...
function Weekly3(props) {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_contentLayout__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    src: "".concat(props.prefix, "/static/img/landing/unnamed.jpg"),
    alt: "\uB9AC\uC9D3\uAD70\uC988 \uB85C\uACE0",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60
    ...
    background: "".concat(props.prefix, "/static/img/landing/unnamed.jpg"),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 69
    },
...
var Background = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "weekly3__Background",
  componentId: "sc-1e81hl1-0"
})(["background-image:url(", ");background-repeat:repeat;height:200%;width:200%;position:absolute;z-index:-1;transform:rotate(-35deg);"], function (props) {
...
})(["width:1280px;height:720px;background:#1a1a1a;color:rgba(255,255,255,0.8);position:relative;"]);
...
})(["position:absolute;display:flex;width:84vw;height:100%;background:linear-gradient(301deg,#F6F6F6 0%,#FFFFFF 100%);z-index:3;top:0;left:8vw;right:8vw;bottom:0;box-shadow:0 10px 20px rgba(0,0,0,.3);align-items:center;justify-content:center;overflow:hidden;"]);

/***/ })

})
//# sourceMappingURL=weekly3.js.fe73926f31e0ec673d57.hot-update.js.map
...
})(["margin:2px;width:", ";height:66px;", " &:active{box-shadow:inset rgba(0,0,0,0.5) 0px 2px 8px;outline:none;>div{box-shadow:inset rgba(0,0,0,0.5) 0px 2px 8px;}}&:focus{outline:none;}>div{width:", ";height:60px;margin:3px;line-height:64px;border-radius:12px;font-weight:bold;font-size:30px;}"], function (props) {
...
var Screen = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  ...
  return props.length > 12 ? '24px' : '40px;';
});
...
//# sourceMappingURL=weekly4.js.7d70263da4274d100ce2.hot-update.js.map
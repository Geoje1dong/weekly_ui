...
})(["background:none;color:#fff;border:1px solid #fff;box-shadow:0 2px 0 rgba(0,0,0,0.045);text-shadow:0 -1px 0 rgba(0,0,0,0.12);transition:all .3s;cursor:pointer;font-weight:inherit;padding:4px 8px;font-size:0.6rem;border-radius:4px;&:hover{outline:none;background:rgba(255,255,255,0.9);color:#000;}"]);
...
})(["width:280px;>dl{>dt{font-size:0.6rem;font-weight:200;color:rgba(255,255,255,0.2);padding:0;margin:0;}>dd{font-size:0.82rem;font-weight:400;padding-top:8px;margin:0;word-break:keep-all;}}"]);
...
//# sourceMappingURL=weekly3.js.8d5454e777f46ac3f3e8.hot-update.js.map
...
function ScaleSlide(_ref) {
  ...
  var handleMouseOver = function handleMouseOver(current) {
    setMouseOver(current);
    alert(mouseOver);
  };
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("div", {
    ...
    return __jsx(SlidetextStyle, {
      ...
      next: nextSlide,
      prev: prevSlide,
      onMouseOver: mouseOver(currentSlide),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 78
      },
...
//# sourceMappingURL=weekly3.js.9aa1bb1ecd373324dc64.hot-update.js.map
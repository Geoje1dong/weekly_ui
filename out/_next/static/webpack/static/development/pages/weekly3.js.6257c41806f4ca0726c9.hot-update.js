...
})(["width:360px;position:absolute;bottom:0;left:0;>dl{margin-top:20px;transition:all 0.4s cubic-bezier(0,0,0.2,1);opacity:0;transform:translateY(20px);", " opacity:", ";transform:", ";transition-delay:0.4s;>dt{font-size:0.6rem;font-weight:200;color:rgba(255,255,255,0.2);padding:0;margin:0;}>dd{font-size:0.82rem;font-weight:400;padding-top:8px;margin:0;word-break:keep-all;}}"], function (props) {
  return props.open && 'opacity:1; transform:translateY(0px);';
}, function (props) {
...
//# sourceMappingURL=weekly3.js.6257c41806f4ca0726c9.hot-update.js.map
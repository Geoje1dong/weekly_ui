...
})(["width:360px;position:absolute;bottom:0;left:0;>dl{margin-top:20px;transition:all 0.4s cubic-bezier(0,0,0.2,1);opacity:0;transform:translateY(20px);", " transition-delay:0.4s;>dt{font-size:0.6rem;font-weight:200;color:rgba(255,255,255,0.2);padding:0;margin:0;}>dd{font-size:0.82rem;font-weight:400;padding-top:8px;margin:0;word-break:keep-all;}}"], function (props) {
...
//# sourceMappingURL=weekly3.js.25548bf521bd81ae2ed8.hot-update.js.map
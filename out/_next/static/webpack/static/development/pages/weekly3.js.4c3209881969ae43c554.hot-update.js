...
function ScaleSlide(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(Slide, {
    __source: {
...
})(["margin:0 2rem;height:67%;display:flex;overflow:hidden;position:relative;z-index:0;>ul{height:100%;background:#000;position:relative;flex:0 0 60%;margin-right:6%;height:100%;&:first-child{height:auto;}&:nth-child(2){margin-left:12%;}&:last-child{>li>div>div{opacity:0.4 !important;}}}"]);
...
//# sourceMappingURL=weekly3.js.4c3209881969ae43c554.hot-update.js.map
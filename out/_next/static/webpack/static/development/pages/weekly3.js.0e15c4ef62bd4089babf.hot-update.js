...
})(["width:360px;position:absolute;bottom:0;left:0;>dl{margin-top:20px;opacity:", ";transform:", ";transition:all 0.4s cubic-bezier(0,0,0.2,1);transition-delay:0.4s;>dt{font-size:0.6rem;font-weight:200;color:rgba(255,255,255,0.2);padding:0;margin:0;}>dd{font-size:0.82rem;font-weight:400;padding-top:8px;margin:0;word-break:keep-all;}}"], function (props) {
  return props.open ? '1' : '0';
}, function (props) {
  return props.open ? 'translateY(0px);' : 'translateY(20px);';
});
...
})(["margin:0 2rem;height:500px;display:flex;overflow:hidden;position:relative;z-index:0;>ul{height:100%;background:#000;position:relative;flex:0 0 55%;margin-right:4%;height:100%;&:first-child{margin-left:12%;}&:last-child{>li>div>div{opacity:0.4 !important;}}}"]);
...
//# sourceMappingURL=weekly3.js.0e15c4ef62bd4089babf.hot-update.js.map
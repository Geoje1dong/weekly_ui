...
})(["margin:0 2rem;height:calc(100% - 120px);display:flex;overflow:hidden;position:relative;z-index:0;align-items:flex-end;>ul{height:500px;background:#000;position:relative;flex:0 0 55%;margin-right:4%;&:first-child{margin-left:12%;", " transition:height 0.5s cubic-bezier(0,0,0.2,1);transition-delay:0.4s;>div >div{", "}}&:last-child{>li>div>div{opacity:0.4 !important;}}}"], function (props) {
  return props.open && 'height:600px; ';
}, function (props) {
  return props.open && 'transform:scale(1.3);';
});
...
//# sourceMappingURL=weekly3.js.2c7aff4c60cedf3aa4e5.hot-update.js.map
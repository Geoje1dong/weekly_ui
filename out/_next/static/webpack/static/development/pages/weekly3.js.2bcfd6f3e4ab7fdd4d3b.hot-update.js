...
function getprint() {
  ...
  subSlidesData = subSlidesData.concat(firstData); // console.log(firstData);

  console.log(subSlidesData); // return subSlidesData;
...
function Weekly3(props) {
  ...
  var _React$useState3 = react__WEBPACK_IMPORTED_MODULE_1___default.a.useState(false),
      ...
      subSlidesData = _React$useState4[0],
      setSubSlidesData = _React$useState4[1];

  var nextSlide = getNextPrev('next', currentSlide);
  var prevSlide = getNextPrev('prev', currentSlide);
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_components_contentLayout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    __self: this
  }, mainSlidesData.map(function (slide) {
    ...
    __self: this
  }, subSlidesData.map(function (slide, index) {
    return __jsx(SlideStyle, {
      background: slide.img,
      key: index,
      current: currentSlide,
...
var SlideOut = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["keyframes"])(["to{top:-100%;}"]);
var ScaleKeyprame = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["keyframes"])(["0%{transform:scale(1);}40%{transform:scale(1.2);}100%{transform:scale(1);}"]);
var ShowBackground = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__ShowBackground",
...
var SlideStyle = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].li.withConfig({
  displayName: "weekly3__SlideStyle",
  componentId: "sc-1e81hl1-1"
})(["position:absolute;top:0;left:0;right:0;bottom:0;height:100%;display:none;", "  ", " ", "  overflow:hidden;>div{position:relative;height:inherit;", "  ", "  ", "  transition:all 0.5s cubic-bezier(0,0,0.2,1);>div{background-image:url(", ");background-size:cover;background-repeat:no-repeat;background-position:center;height:inherit;", " transition:all 0.5s cubic-bezier(0,0,0.2,1);}}"], function (props) {
  ...
  if (props.current === props.index) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["animation:", " 0.6s cubic-bezier(0,0,0.2,1);"], ScaleKeyprame);
  }
});
var Slide = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__Slide",
  componentId: "sc-1e81hl1-2"
})(["margin:0 2rem;height:67%;display:flex;overflow:hidden;>ul{height:100%;background:#000;position:relative;flex:0 0 60%;margin-right:6%;height:100%;&:first-child{margin-left:12%;}&:last-child{>li>div>div{opacity:0.5 !important;}}}"]);
var TextSlide = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__TextSlide",
  componentId: "sc-1e81hl1-3"
})(["width:inherit;position:absolute;bottom:28%;left:2rem;z-index:4;height:100px;width:600px;overflow:hidden;"]);
var SlidetextStyle = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].li.withConfig({
  displayName: "weekly3__SlidetextStyle",
  componentId: "sc-1e81hl1-4"
})(["position:absolute;top:0;left:0;right:0;bottom:0;height:100%;display:none;", "  ", " ", "  >div{font-size:2rem;font-weight:700;color:#fff;position:relative;height:inherit;", "  ", "  ", "  transition:all 0.5s cubic-bezier(0,0,0.2,1);>div{transform:matrix(1,0,0,1,0,0);text-shadow:0px 4px 5px rgba(0,0,0,0.6);}}"], function (props) {
  return props.prev === props.index && 'z-index:0; display:block;';
}, function (props) {
  return props.current === props.index && 'z-index:2; display:block;';
}, function (props) {
...
var Intro = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__Intro",
  componentId: "sc-1e81hl1-5"
})(["display:flex;>p{font-size:0.8rem;line-height:2em;padding:0 2rem;color:rgba(255,255,255,1);font-weight:300;margin:0;&:last-child{padding-right:0;}>strong{display:block;font-weight:300;color:rgba(229,34,32,0.9);}}"]);
var Logo = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__Logo",
  componentId: "sc-1e81hl1-6"
})(["display:flex;background:#fff;border-radius:12px;overflow:hidden;transform:rotate(45deg);width:50px;height:50px;justify-content:center;align-items:center;margin:5px auto 5px 5px;>img{height:50px;width:auto;transform:rotate(-45deg);}"]);
var SoundBar = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__SoundBar",
  componentId: "sc-1e81hl1-7"
...
var HeaderBox = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "weekly3__HeaderBox",
  componentId: "sc-1e81hl1-8"
...
//# sourceMappingURL=weekly3.js.2bcfd6f3e4ab7fdd4d3b.hot-update.js.map
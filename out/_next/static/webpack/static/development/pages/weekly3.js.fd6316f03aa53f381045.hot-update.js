...
})(["background:none;color:#fff;border:1px solid #fff;box-shadow:0 2px 0 rgba(0,0,0,0.045);text-shadow:0 -1px 0 rgba(0,0,0,0.12);transition:all .3s;cursor:pointer;font-weight:inherit;padding:4px 8px;font-size:0.6rem;&:hover{outline:none;background:rgba(255,255,255,0.9);color:#000;}"]);
...
//# sourceMappingURL=weekly3.js.fd6316f03aa53f381045.hot-update.js.map
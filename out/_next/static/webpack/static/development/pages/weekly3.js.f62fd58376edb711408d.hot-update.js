...
})(["position:absolute;top:0;left:0;right:0;height:100%;background:#1a1a1a;z-index:3;", ""], function (props) {
  return props.open ? 'background:red;' : "animation:".concat(SlideOut, " 0.5s cubic-bezier(0, 0, 0.2, 1) forwards; animation-delay: ").concat(function (props) {
    return props.delay;
  }, ";");
});
...
//# sourceMappingURL=weekly3.js.f62fd58376edb711408d.hot-update.js.map
...
})(["margin:2px;width:", ";height:66px;", " &:active{box-shadow:inset rgba(0,0,0,0.5) 0px 2px 8px;outline:none;>div{box-shadow:inset rgba(0,0,0,0.3) 0px 2px 8px;}}&:focus{outline:none;}>div{width:", ";height:60px;margin:3px;line-height:64px;border-radius:12px;font-weight:bold;font-size:30px;}"], function (props) {
...
//# sourceMappingURL=weekly4.js.5d60a9ce1d1892a6424a.hot-update.js.map